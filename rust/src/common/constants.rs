...
pub const TABLE_COL_SHORT_WIDTH: &str = "180px";
...
pub const STATUS_SEARCH_OPTION_APPLIED: &str = "Applied";
pub const STATUS_SEARCH_OPTION_FAILED: &str = "Failed";
pub const STATUS_SEARCH_OPTION_ALL: &str = "";
...
pub const MAINNET_2_CHAIN_ID: &str = "a7351a";
pub const MAINNET_1_CHAIN_ID: &str = "5f704c";
...
pub const QUERY_PARAM_STATE_HASH: &str = "q-state-hash";
pub const QUERY_PARAM_SLOT: &str = "q-slot";
pub const QUERY_PARAM_BLOCK_PRODUCER: &str = "q-block-producer";
pub const QUERY_PARAM_CANONICAL: &str = "canonical";
...
pub const QUERY_PARAM_FROM: &str = "q-from";
...
pub const QUERY_PARAM_TXN_TYPE: &str = "txn-type";
