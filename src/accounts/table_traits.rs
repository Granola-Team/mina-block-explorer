        ...
        self.iter()
            .map(|all_acct_sum_opt| match all_acct_sum_opt {
                Some(all_account_sum) => vec![
                    convert_to_link(all_account_sum.pk.to_string(),format!("/accounts/{}",all_account_sum.pk.to_string())),
                    ...
                    convert_to_link(all_account_sum.delegate.to_string(),format!("/accounts/{}",all_account_sum.delegate.to_string())),
