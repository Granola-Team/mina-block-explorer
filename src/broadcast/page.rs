    ...
    view! {
        <PageContainer>
            <AppSection>
                ...
                <p class="px-8 text-sm">"Generate an offline transaction using the Ledger and submit the transaction to the network using the form below. This works for both payment and delegation transaction types."</p>
                <BroadcastForm endpoint="https://api.minaexplorer.com/broadcast/transaction".to_string() />
            </AppSection>
            <AppSection>
